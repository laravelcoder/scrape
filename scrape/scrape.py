...
def get_parser():
    ...
    parser.add_argument('query', metavar='QUERY', type=str, nargs='*', help='URLs/files to scrape')
    parser.add_argument('--html', help='write files as HTML', action='store_true')
    parser.add_argument('-ow', '--overwrite', action='store_true', help='overwrite a file if it exists')
